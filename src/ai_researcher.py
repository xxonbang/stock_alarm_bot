...
7. 기술적 지표 판단 기준:
   ...
   - 눌림목(Pullback) 진단: 상승 정배열 상태에서 주가가 20일 이동평균선에 근접(이격도 100~103%)하고 거래량이 평소 대비 급감했다면, 이를 '매수 적기인 눌림목'으로 판단하여 기술적 반등 가능성을 리포트에 명시하십시오. 만약 20일선을 하향 이탈했다면 '추세 붕괴 위험'으로 경고하십시오.
